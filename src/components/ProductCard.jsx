...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
    <div className="bg-gradient-to-br from-green-50 to-blue-50 shadow-lg rounded-2xl p-5 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-green-200">
    <div className="relative">
      <div className="absolute top-3 right-3 bg-green-100/90 backdrop-blur-sm px-2 py-1 rounded-full text-sm font-medium text-green-700">
        ⭐ {product.rating}
      </div>
    </div>
    ...
    <div className="mt-4">
      ...
      <div className="flex gap-2 mt-4">
        ...
        <button className="bg-green-100 hover:bg-green-200 text-green-700 text-sm font-medium py-2 px-3 rounded-lg transition-colors duration-200">
          💚
        </button>
      </div>
    </div>
